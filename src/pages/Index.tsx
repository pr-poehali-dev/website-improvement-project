  ...
  const services = [
    {
      ...
      description: "Системы спутникового мониторинга транспорта с использованием ГЛОНАСС/GPS технологий",
      icon: "Satellite",
      features: ["Отслеживание местоположения", "Контроль маршрутов", "Онлайн мониторинг"]
    },
    {
      title: "Контроль топлива", 
      description: "Системы контроля расхода и учета топлива для автотранспорта",
      icon: "Fuel",
      features: ["Датчики уровня топлива", "Анализ расхода", "Предотвращение слива"]
    },
    {
      title: "Системы СИ Игла",
      description: "Противоугонные системы блокировки двигателя для защиты автотранспорта",
      icon: "Shield",
      features: ["Блокировка двигателя", "Дистанционное управление", "SMS оповещения"]
    }
  ];
  ...
  const reviews = [
    {
      ...
      company: "Логистик Групп",
      rating: 5,
      text: "Установили ГЛОНАСС на весь автопарк. Экономия топлива составила 15%. Отличная работа!",
      avatar: "СВ"
    },
    {
      name: "Анна Кузнецова", 
      company: "Транс-Юг",
      rating: 5,
      text: "Системы контроля топлива окупились за 3 месяца. Профессиональный монтаж и поддержка.",
      avatar: "АК"
    },
    {
      name: "Михаил Петров",
      company: "Стройтранс",
      rating: 4,
      text: "СИ Игла спасла уже 2 машины от угона. Рекомендую всем владельцам автопарков.",
      avatar: "МП"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                Мониторинг 
                <span className="text-primary"> автотранспорта</span> и ГЛОНАСС
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Полный комплекс услуг по установке и обслуживанию систем 
                спутникового мониторинга транспорта в Ставрополе
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ООО "АПЕКС" - ведущая компания по установке и обслуживанию систем мониторинга 
                автотранспорта в Ставропольском крае. Более 8 лет на рынке транспортной телематики.
              </p>
